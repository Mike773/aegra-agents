"""json_analyzer_v4: инструмент element_slice — кросс-метричный срез по одному
...
from langgraph_executor.aegra_agents.json_analyzer_v4.loader import load_dataset_obj
