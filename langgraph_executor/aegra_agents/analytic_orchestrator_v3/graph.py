...
# Бизнес-оркестратор использует аналитика json_analyzer_v4 (= v3 + загрузка
# rankings/ex/rr и peer-агрегатов уровней ORG/TERR/OFFICE в SQLite): без
# аналитики по бенчмарку, pop-сравнения только у метрик с указанным планом.
from ..json_analyzer_v4.graph import graph as json_analyzer_graph
